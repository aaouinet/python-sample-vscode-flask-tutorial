[![Build Status](https://aaouinet.visualstudio.com/MyFirstProject/_apis/build/status/aaouinet.python-sample-vscode-flask-tutorial?branchName=master)](https://aaouinet.visualstudio.com/MyFirstProject/_build/latest?definitionId=1&branchName=master)
